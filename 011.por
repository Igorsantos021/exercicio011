/*
Médias
Este exemplo pede ao usuario que informe tres médias. Logo após, calcule e exibe a média final destas notas. por ultimo,
verifica se alguma das médias parciais é menor que a média final e a exibi (caso exista).
*/
programa {
  funcao inicio() {
    real m1, m2, m3, media
